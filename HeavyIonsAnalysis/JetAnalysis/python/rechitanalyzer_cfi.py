...
rechitanalyzer.HBHETreePtMin = cms.untracked.double(-999)
rechitanalyzer.HFTreePtMin = cms.untracked.double(-999)
rechitanalyzer.EBTreePtMin = cms.untracked.double(-999)
rechitanalyzer.EETreePtMin = cms.untracked.double(-999)
