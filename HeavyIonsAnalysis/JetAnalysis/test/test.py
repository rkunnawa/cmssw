...
config.General.requestName = 'HiForest_pthat80_MC_withHCALmethod0_1KEvents'
#config.General.failureLimit = 1000

config.section_('JobType')
config.JobType.psetName = 'runForest_PbPb_MIX_75X.py'
config.JobType.pluginName = 'Analysis'
config.JobType.outputFiles = ['HiForest_pthat80_753p1_Method0.root']
...
config.Data.outLFNDirBase = '/store/user/rkunnawa/Run2_pthat80_HiForest_HCAL_Method0_1KEvents/'
...
config.Data.inputDataset = '/PyquenUnquenched_Dijet_NcollFilt_pthat80_740pre8_MCHI1_74_V4_GEN-SIM_v3/istaslis-PyquenUnquenched_Dijet_NcollFilt_pthat80_753patch1_customized_RECODEBUG-fc27ae3aaa1b75922ce282ddc77e17de/USER '
