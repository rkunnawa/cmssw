...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step4_RECO1.root')
)
...
process.RECODEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step5_RECO.root'),
...
process.reconstruction_step = cms.Path(process.reconstructionHeavyIonsStep2)
process.endjob_step = cms.EndPath(process.endOfProcess)
process.RECODEBUGoutput_step = cms.EndPath(process.RECODEBUGoutput)

# Schedule definition
process.schedule = cms.Schedule(process.reconstruction_step,process.endjob_step,process.RECODEBUGoutput_step)
